...
// Those are IDs from specific channels(developer mode enabled in discord)
...
const nonAppreciationResponse = [
    "im calling the fbi to see who asked",
...
const needsBotAsArgs = ["help", "snipe", "morewater", "check", "guess"];
...
const messageForWater =
    "Being dead inside is not an excuse for not drinking water";
